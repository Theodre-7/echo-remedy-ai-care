...
const Modal: React.FC<ModalProps> = ({ title, content, isOpen, onClose }) => {
    ...
    <div className="space-y-6">
      <div>
        ...
        <div className="space-y-3">
          <div className="flex items-center gap-3">
            ...
            <a 
              href="https://www.linkedin.com/in/sanjeevi-ram-274947298/" 
              target="_blank" 
      ...
      <div>
        ...
        <ul className="space-y-2">
          {[
            'Upload photo & analyze visible disease or infection',
            'AI-generated health summary',
            'MedxoBot: Smart assistant for disorder queries & emergencies',
            'Scan History with timestamp',
            'Downloadable health reports',
            'Home remedies tailored to symptoms',
  ...
  const renderPrivacyPolicyContent = () => (
    <div className="space-y-4">
      ...
      <ul className="space-y-3">
        {[
          { text: 'Uploaded images are securely stored and used only for AI analysis', highlight: 'securely' },
          { text: 'Conversations with MedxoBot are anonymized to improve future accuracy', highlight: 'anonymized' },
          { text: 'No personal data is ever shared or sold to third parties', highlight: 'personal data' },
          { text: 'Cookies may be used to improve user session experience', highlight: null },
          { text: 'Users may request deletion of their data at any time', highlight: null },
          { text: 'By using EchoRemedy, users agree to this policy', highlight: null }
        ].map((item, index) => (
          <li key={index} className="flex items-start gap-2">
  ...
  const renderTermsContent = () => (
    <div className="space-y-4">
      ...
      <ul className="space-y-3">
        {[
          { text: 'AI-generated remedies are not a substitute for professional medical advice', warning: true },
          { text: 'Users are responsible for decisions based on AI suggestions', warning: false },
          { text: 'Misuse or offensive behavior results in account suspension', warning: false },
          { text: 'EchoRemedy can update services or features without prior notice', warning: false },
          { text: 'Users must be 13 years or older to use the platform', warning: false },
          { text: 'For emergencies, always consult a licensed healthcare provider', warning: true }
        ].map((item, index) => (
          <li key={index} className="flex items-start gap-2">
